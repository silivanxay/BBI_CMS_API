...
urlpatterns = [
    ...
    path('api/v1/user/register_user/', RegisterUserSerializerView.as_view(), name='auth_register'),
    path('api/v1/user/register_agent/', RegisterAgentSerializerView.as_view(), name='auth_register'),
